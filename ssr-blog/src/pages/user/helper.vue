...
export default {
    data() {
        return {
            ...
            deploy: {
                images: [
                    require('./../../../static/assets/deploy0.png'),
                    require('./../../../static/assets/deploy1.png'),
                    require('./../../../static/assets/deploy2.png')
                ],
                status: "process",
                active: 0,
            },
            use: {
                images: [
                    require('./../../../static/assets/use0.png'),
                    require('./../../../static/assets/use1.png'),
                    require('./../../../static/assets/use2.png')
                ],
                status: "process",
                active: 0,
            }
